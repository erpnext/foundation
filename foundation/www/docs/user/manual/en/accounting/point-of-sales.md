...
<img class="screenshot" alt="POS Customer" src="{{docs_base_url}}/assets/img/accounting/pos-customer.png">
...
<img class="screenshot" alt="POS Item" src="{{docs_base_url}}/assets/img/accounting/pos-item.png">
...
<img class="screenshot" alt="POS Item" src="{{docs_base_url}}/assets/img/accounting/pos_deleted_item.gif">
...
<img class="screenshot" alt="POS Payment" src="{{docs_base_url}}/assets/img/accounting/pos-payment.png">
...
<img class="screenshot" alt="POS Payment" src="{{docs_base_url}}/assets/img/accounting/write-off.png">
...
<img class="screenshot" alt="POS Payment" src="{{docs_base_url}}/assets/img/accounting/change-amount.png">
...
<img class="screenshot" alt="POS Payment" src="{{docs_base_url}}/assets/img/accounting/offline-records.png">
...
<img class="screenshot" alt="POS Payment" src="{{docs_base_url}}/assets/img/accounting/pos-email.png">
...
<img class="screenshot" alt="POS Payment" src="{{docs_base_url}}/assets/img/accounting/pos-closing-voucher.png">
