...
<img class="screenshot" alt="Bank Reconciliation statement" src="{{docs_base_url}}/assets/img/accounting/bank-reconciliation-2.png">
...
<img class="screenshot" alt="Bank Reconciliation" src="{{docs_base_url}}/assets/img/accounting/bank-reconciliation.png">
