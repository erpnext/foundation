...
<img class="screenshot" alt="Sales Invoice" src="{{docs_base_url}}/assets/img/accounting/sales-invoice.png">
...
<img class="screenshot" alt="POS Invoice" src="{{docs_base_url}}/assets/img/accounting/sales-invoice-fetch-batch.png">
...
<img class="screenshot" alt="POS Invoice" src="{{docs_base_url}}/assets/img/accounting/pos-sales-invoice.png">
...
<img class="screenshot" alt="POS Invoice" src="{{docs_base_url}}/assets/img/accounting/billing-timesheet-sales-invoice.png">
