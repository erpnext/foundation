...
<img class="screenshot" alt="Budget" src="{{docs_base_url}}/assets/img/accounting/budgeting-cost-center.png">
...
<img class="screenshot" alt="Budget" src="{{docs_base_url}}/assets/img/accounting/budget-account.png">
...
<img class="screenshot" alt="Monthly Distribution" src="{{docs_base_url}}/assets/img/accounting/monthly-budget-distribution.png">
...
<img class="screenshot" alt="Monthly Distribution" src="{{docs_base_url}}/assets/img/accounting/budget-warning.png">
...
<img class="screenshot" alt="Budget Variance Report" src="{{docs_base_url}}/assets/img/accounting/budget-variance-report.png">
