...
<img class="screenshot" alt="Steuerregel" src="{{docs_base_url}}/assets/img/accounting/tax-rule.png">
...
<img class="screenshot" alt="Steuerregel" src="{{docs_base_url}}/assets/img/accounting/tax-rule-1.png">

<img class="screenshot" alt="Steuerregel" src="{{docs_base_url}}/assets/img/accounting/tax-rule-2.png">
