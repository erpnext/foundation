...
<img class="screenshot" alt="Eröffnungskonto" src="{{docs_base_url}}/assets/img/accounting/opening-account-1.png">
...
<img class="screenshot" alt="Probebilanz" src="{{docs_base_url}}/assets/img/accounting/opening-4.png">
